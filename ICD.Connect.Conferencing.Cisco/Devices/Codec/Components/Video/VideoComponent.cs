...
namespace ICD.Connect.Conferencing.Cisco.Devices.Codec.Components.Video
{
	...
	public sealed class VideoComponent : AbstractCiscoComponent
	{
		...
		/// </summary>
		[PublicAPI]
		public event EventHandler<BoolEventArgs> OnMainVideoMutedChanged;
		...
		/// </summary>
		[PublicAPI]
		public bool MainVideoMuted
		{
			get { return m_MainVideoMuted; }
			private set
			{
				if (value == m_MainVideoMuted)
					return;
		...
		{
			MainVideoMuted = XmlUtils.GetInnerXml(xml) == "On";
		}
		...
		public override void BuildConsoleStatus(AddStatusRowDelegate addRow)
		{
			...
			addRow("Main Video Mute", MainVideoMuted);
