...
{
	[KrangSettings("DirectoryMiddlewareClient", typeof (DirectoryMiddlewareClientDevice))]
	public sealed class DirectoryMiddlewareClientDeviceSettings : AbstractDeviceSettings, IUriSettings,
		IWebProxySettings
	{
		...
		{
			get { return m_UriProperties.UriUsername; }
			set { m_UriProperties.UriUsername = value; }
		}
		...
		{
			get { return m_UriProperties.UriPassword; }
			set { m_UriProperties.UriPassword = value; }
		}
		...
		{
			get { return m_UriProperties.UriHost; }
			set { m_UriProperties.UriHost = value; }
		}
		...
		{
			get { return m_UriProperties.UriPort; }
			set { m_UriProperties.UriPort = value; }
		}
		...
		{
			get { return m_UriProperties.UriScheme; }
			set { m_UriProperties.UriScheme = value; }
		}
		...
		{
			get { return m_UriProperties.UriPath; }
			set { m_UriProperties.UriPath = value; }
		}
		...
		{
			get { return m_UriProperties.UriQuery; }
			set { m_UriProperties.UriQuery = value; }
		}
		...
		{
			get { return m_UriProperties.UriFragment; }
			set { m_UriProperties.UriFragment = value; }
		}
		...
		{
			get { return m_WebProxyProperties.ProxyUsername; }
			set { m_WebProxyProperties.ProxyUsername = value; }
		}
		...
		{
			get { return m_WebProxyProperties.ProxyPassword; }
			set { m_WebProxyProperties.ProxyPassword = value; }
		}
		...
		{
			get { return m_WebProxyProperties.ProxyHost; }
			set { m_WebProxyProperties.ProxyHost = value; }
		}
		...
		{
			get { return m_WebProxyProperties.ProxyPort; }
			set { m_WebProxyProperties.ProxyPort = value; }
		}
		...
		{
			get { return m_WebProxyProperties.ProxyScheme; }
			set { m_WebProxyProperties.ProxyScheme = value; }
		}
		...
		/// Constructor.
		/// </summary>
		public DirectoryMiddlewareClientDeviceSettings()
		{
		...
		{
			m_UriProperties.ApplyDefaultValues(null, null, null, 5000, Uri.UriSchemeHttp, null, null, null);
		}
	}
}