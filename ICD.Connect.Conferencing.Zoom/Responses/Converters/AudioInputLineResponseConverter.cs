...
namespace ICD.Connect.Conferencing.Zoom.Responses.Converters
{
	...
	public sealed class AudioInputLineConverter : AbstractGenericJsonConverter<AudioInputLine>
	{
		...
		protected override void WriteProperties(JsonWriter writer, AudioInputLine value, JsonSerializer serializer)
		{
			base.WriteProperties(writer, value, serializer);
		...
		protected override void ReadProperty(string property, JsonReader reader, AudioInputLine instance, JsonSerializer serializer)
		{
			switch (property)
			{
				case ATTR_ALIAS:
