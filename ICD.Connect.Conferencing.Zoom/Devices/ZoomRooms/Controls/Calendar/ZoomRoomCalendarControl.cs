...
using Booking = ICD.Connect.Conferencing.Zoom.Devices.ZoomRooms.Components.Bookings.Booking;

namespace ICD.Connect.Conferencing.Zoom.Devices.ZoomRooms.Controls.Calendar
{
