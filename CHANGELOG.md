...
## [20.2.2] - 2023-02-13
### Changed
 - Cisco wait until webex participant list is parsed before resetting the poll timer
...
### Changed
 ...
 - Cisco - Added test cases for cloud registered bookings, fixed current test cases
